...
#include "Particle.h"
#line 1 "/Users/ramikhosho/RamiLab12/src/RamiLab12.ino"
// libraries
#include "MQTT.h"
...
void loop();
void resetDisplay();
#line 5 "/Users/ramikhosho/RamiLab12/src/RamiLab12.ino"
#define LEDPIN D7
...
void setup()
{
  ...
  client.subscribe("testtopic/CoolTopic");
...
void loop()
{
  ...
  if (display.pressedA())
  {
    client.publish("testtopic/CoolTopic", "Pressed A");
  }
  if (display.pressedB())
  {
    client.publish("testtopic/CoolTopic", "Pressed B");
  }
  if (display.pressedC())
  {
    client.publish("testtopic/CoolTopic", "Pressed C");
  }
}
void callback(char *topic, byte *payload, unsigned int length)
{
